...
var Context = /*#__PURE__*/React.createContext(defaultState);
...
var BatteryLevel = function BatteryLevel() {
  ...
  var cellList = React.useMemo(function () {
  ...
  return React__default.createElement("g", null, React__default.createElement("defs", null, React__default.createElement("clipPath", {
    ...
    width: width,
    height: height
  })), noOfCells < 2 && gradFill && React__default.createElement("linearGradient", {
  ...
  }))), noOfCells === 1 && React__default.createElement("g", null, gradFill ? React__default.createElement("rect", {
  ...
  })), React__default.createElement("g", null, noOfCells > 1 && cellList.map(function (_item, index) {
...
function Charging(pathProps) {
  ...
  var _customization$CHARGI = customization[CHARGING_FLASH],
    ...
    scale = _customization$CHARGI.scale,
...
var BatteryGauge = function BatteryGauge(_ref) {
  ...
  var _ref$size = _ref.size,
    ...
    _ref$chargingStartVal = _ref.chargingStartValue,
    chargingStartValue = _ref$chargingStartVal === void 0 ? defaultState.chargingStartValue : _ref$chargingStartVal,
    ...
    restSvgProps = _objectWithoutPropertiesLoose(_ref, _excluded$2);
  ...
  return React__default.createElement(Canvas, Object.assign({
    ...
    clipPathHash: clipPathHash
  }, restSvgProps), React__default.createElement("g", {
    transform: orientation === 'vertical' ? "rotate(-90," + CANVAS_WIDTH / 2 + "," + canvasHeight / 2 + ")" // rotate at right top corner
    : ''
  }, React__default.createElement(Battery, null), React__default.createElement(BatteryLevel, null), charging ? React__default.createElement(Charging, null) : React__default.createElement(ReadingText, {
    formatValue: formatValue
  }), children));
};

exports.BatteryGauge = BatteryGauge;
exports.default = BatteryGauge;
//# sourceMappingURL=react-battery-gauge.cjs.development.js.map
